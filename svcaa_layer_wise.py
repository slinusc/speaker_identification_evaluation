...
root_dir = '/home/rag/experimental_trial/data/all_speakers_xlrs_finetuned'  # Anpassung notwendig
...
results_df.to_csv('results/svcca_results_50_xlsr_finetunded.csv', index=False)
print("Ergebnisse erfolgreich in 'results/svcca_results_50_xlsr_finetunded.csv' gespeichert.")
